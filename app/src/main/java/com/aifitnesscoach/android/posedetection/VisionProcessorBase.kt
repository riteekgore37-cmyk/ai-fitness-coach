...
import com.aifitnesscoach.android.posedetection.FrameMetadata
import com.aifitnesscoach.android.posedetection.GraphicOverlay
import com.aifitnesscoach.android.posedetection.Utils.BitmapUtils
import com.aifitnesscoach.android.posedetection.Utils.CameraImageGraphic
import com.aifitnesscoach.android.posedetection.Utils.PreferenceUtils
import com.aifitnesscoach.android.posedetection.Utils.ScopedExecutor
import com.aifitnesscoach.android.posedetection.VisionImageProcessor
...
abstract class VisionProcessorBase<T>(context: Context) : VisionImageProcessor {
    ...
    override fun processBitmap(bitmap: Bitmap?, graphicOverlay: GraphicOverlay) {
        ...
        if (isMlImageEnabled(graphicOverlay.context)) {
            ...
            requestDetectInImage(
                mlImage, graphicOverlay, null, false, frameStartMs
            )
            mlImage.close()
            return
        }
        ...
        requestDetectInImage(
            InputImage.fromBitmap(bitmap!!, 0), graphicOverlay, null, false, frameStartMs
        )
    }
    ...
    private fun processImage(
        ...
        if (isMlImageEnabled(graphicOverlay.context)) {
            ...
            requestDetectInImage(
                mlImage, graphicOverlay, bitmap, true, frameStartMs
        ...
        requestDetectInImage(
            ...
            ), graphicOverlay, bitmap,/* shouldShowFps= */ true, frameStartMs
        ).addOnSuccessListener(executor) { processLatestImage(graphicOverlay) }
    }
        ...
        if (isMlImageEnabled(graphicOverlay.context)) {
            val mlImage =
                MediaMlImageBuilder(image.image!!).setRotation(image.imageInfo.rotationDegrees)
                    .build()
            requestDetectInImage(
                mlImage, graphicOverlay,/* originalCameraImage= */
